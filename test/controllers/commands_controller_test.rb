...
class CommandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create command" do
    assert_difference('Command.count') do
      post commands_url, params: { command: { category: @command.category, command: @command.command, note: @command.note, title: @command.title } }
    end
  ...
  test "should update command" do
    patch command_url(@command), params: { command: { category: @command.category, command: @command.command, note: @command.note, title: @command.title } }
